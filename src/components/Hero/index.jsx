    ...
    >
      <Container h="100%" display="flex" alignItems="center">
        ...
        >
              ...
              <Box>
                <Box display="flex" flexDirection="column">
                  <Text
                    ...
                    lineHeight="120%"
                  >
                    Join our premier monthly meetup for startup founders and
                    tech visionaries
                  </Text>
                  <Heading
                    color="#5c00b3"
                ...
                <Text
                  ...
                  my={{ base: "0", lg: "20px" }}
                >
                  Every last Friday of the month, we bring together the
                  brightest minds in our local tech ecosystem. Whether
                  you&apos;re a seasoned entrepreneur or just starting your
                  journey, Founder&apos;s Friday is your launchpad for new
          ...
          <Box pos="relative" zIndex="1" w={{ base: "100%", lg: "50%" }}>
            <motion.div
              initial={{ opacity: 0, x: 50 }}
              animate={{ opacity: 1, x: 0 }}
              transition={{ duration: 1 }}
